...
const RecruitmentQCLocalHiringWorksheet = () => {
        ...
        <div className="space-y-8">
          <section className="bg-white/90 backdrop-blur rounded-4xl border border-slate-200 shadow-sm px-6 md:px-10 py-8 flex flex-col gap-6 xl:flex-row xl:items-start xl:justify-between">
            <div className="max-w-4xl space-y-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-slate-900">Track every assigned lead</h1>
                <p className="text-sm md:text-base text-slate-600 mt-3 leading-relaxed">
                  Use filters to quickly find candidates, see outcomes, and open full profiles for context.
                </p>
              </div>
            </div>
...
export default RecruitmentQCLocalHiringWorksheet;
