...
const HRRecruiterDashboard = () => {
  ...
  const actionCards = [
    {
      title: 'Position MIS',
      description: 'View positions assigned to you and their current status.',
  ...
  const countCards = [
    {
      ...
      description: 'Positions that are currently open and active.',
    ...
    },
    {
      ...
      description: 'Total positions you can work on as a recruiter.',
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Manage your assigned positions and move candidates efficiently.</p>
