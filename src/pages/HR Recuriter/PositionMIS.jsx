      ...
      <main className="w-full mx-auto px-2 sm:px-4 pt-20 pb-6">
        <header className="mb-4">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-3">
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">HR Recruiter – Position MIS</h1>
              <p className="text-sm text-gray-600">Browse positions and move candidates through your stages</p>
            </div>
                      ...
                      <tr key={j?._id || idx} className="odd:bg-white even:bg-gray-50 hover:bg-indigo-50/50">
                        ...
                        <td className="px-3 py-2 border-b align-top text-gray-800">
                          <div className="flex items-center gap-2">
                            <button
                              type="button"
                              onClick={() => navigate(`/hr-recruiter/position/${j?._id}`, { state: { job: j } })}
